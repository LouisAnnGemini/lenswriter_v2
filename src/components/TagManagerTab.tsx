...
export function TagManagerTab() {
  ...
  return (
    <div className="p-6 overflow-y-auto flex-1 max-w-2xl mx-auto w-full">
      <h3 className="text-xl font-bold text-stone-800 mb-6">Manage Tags</h3>
      <form onSubmit={handleAddTag} className="mb-8 space-y-3 bg-white p-4 rounded-lg border border-stone-200 shadow-sm">
        <div>
